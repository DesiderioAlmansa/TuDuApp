...
import { getTeam, removeUserFromProject } from "@/services/TeamService"
...
export default function ProjectTeamView(){
    ...
    if(data) return (
        <>
            ...
            <p className="text-2xl font-light text-gray-500 mt-5">Administra el equipo de trabajo que participa en el proyecto</p>
            ...
            <nav className="my-5 flex gap-3">
                ...
                <Link to={`/projects/${projectId}`} className="bg-purple-400 hover:bg-purple-500 px-10 py-3 text-white text-xl
                font-bold cursor-pointer transition-colors">
                    Volver
                </Link>
            </nav>
